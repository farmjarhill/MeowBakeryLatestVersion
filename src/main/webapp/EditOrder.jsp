...
<body>
	...
	<header class="hero">
		...
		<p
			style="font-weight: 600; text-align: center; font-size: 80px; margin: -48px auto; color: #b32040;">Cập
			nhật tình trạng đơn hàng</p>
	</header>
	<section class="edit-product">
		<div class="container-edit">
			<form class="form-edit" action="Update" method="POST">
				<div class="modal-body">
					<div class="form-group">
						<label for="id">ID đơn hàng</label> <input
							value="${order.id_order}" type="text" id="id" name="id" readonly
							required>
					</div>
					<div class="form-group">
						<label for="name">Người đặt hàng</label> <input
							value="${order.name}" type="text" id="name" name="name" readonly
							required>
					</div>
					<div class="form-group">
						<label for="address">Địa chỉ giao hàng</label> <input
							value="${order.address}" type="text" id="address" name="address"
							readonly required>
					</div>
					<div class="form-group">
						<label for="price">Tổng tiền</label> <input type="text"
							value="${order.amount}" id="amount" name="amount" readonly
							required>
					</div>
					<div class="form-group">
						<label for="image">Trạng thái đơn hàng</label> <select
