...
text-decoration: none;}
  ...
  <body>
    ...
    <header class="hero">
      <nav class="cloud">
        <div
          ...
          "
        >
          <img src="./img/Pink Pastel Playful Fun Modern Food and Bakery Logo.png" alt="MeoBakery" style="width: 150px; height: 150px; border-radius: 90px 90px 90px 90px;">
        </div>
        <div id="nav-links-section" class="nav-section">
         
          <a href="Svlet#" class="button">Home</a>
			<ul class="menu-level-top">
								<li class="item-level-1"><a href="#gradient" class="button item-level-1-title"><i class="fa-sharp fa-solid fa-caret-down" style="color: black;"></i> Menu</a>
									<ul class="menu-level-2">						
											
										<li class="item-level-2"><a href="Cupcake.jsp" 
											class="item-level-2-title" style="text-decoration: none;">Cupcake</a></li>
										<li class="item-level-2"><a href="Donut.jsp" 
											class="item-level-2-title" style="text-decoration: none;">Donut</a></li>
											<li class="item-level-2"><a href="Tiramisu.jsp" 
											class="item-level-2-title" style="text-decoration: none;">Tiramisu</a></li>
											<li class="item-level-2"><a href="Mochi.jsp" 
											class="item-level-2-title" style="text-decoration: none;">Mochi</a></li>
											<li class="item-level-2"><a href="Macaron.jsp" 
											class="item-level-2-title" style="text-decoration: none;">Macaron</a></li>
									</ul></li>
							</ul>
                ...
                <div class="container-team">
                  ...
                  <div class="row1">
                    <div class="col-md-3 profile-text-center">
                      <div class="img-box">
                        <img src="img/vu_quynh_anh.jpg" alt="Leader Team" class="img-responsive">
                        <ul>
                    ...
                    <div class="col-md-3 profile-text-center">
                      <div class="img-box">
                        <img src="img/nguyen_vu_quang_minh.jpg" alt="Member 2" class="img-responsive">
                    ...
                    <div class="col-md-3 profile-text-center">
                      <div class="img-box">
                        <img src="img/pham_gia_hien.jpg" alt="Member 2" class="img-responsive">
                        <ul>
                          <a href="#"><li><i class="fa fa-facebook"></i></li></a>
                          <a href="#"><li><i class="fa fa-twitter"></i></li></a>
                          <a href="#"><li><i class="fa fa-linkedin"></i></li></a>
                    ...
                    <div class="col-md-3 profile-text-center">
                      <div class="img-box">
                        <img src="img/thu_uyen.jpg" alt="Member 3" class="img-responsive">
                    ...
                    <div class="col-md-3 profile-text-center">
                      <div class="img-box">
                        <img src="img/about-us.png" alt="Member 4" class="img-responsive">
                        <ul style="padding-left: 35px; margin-left: 20px;">
                          <a href="#"><li><i class="fa fa-facebook"></i></li></a>
                          <a href="#"><li><i class="fa fa-twitter"></i></li></a>
                          <a href="#"><li><i class="fa fa-linkedin"></i></li></a>
                        </ul>
                    ...
                    <div class="col-md-3 profile-text-center">
                      <div class="img-box">
                        <img src="img/to_thi_quy.jpg" alt="Member 5" class="img-responsive">
                        <ul>
                          <a href="#"><li><i class="fa fa-facebook"></i></li></a>
                          <a href="#"><li><i class="fa fa-twitter"></i></li></a>
                          <a href="#"><li><i class="fa fa-linkedin"></i></li></a>
          ...
          <div class="search">
            <input type="text" class="searchTerm" placeholder="Search.." id="input" data-search/>
        ...
        <div id="nav-cart-section" class="cart-section">
          <a href="cart.jsp" style="text-decoration: none; color: white;"><svg class="cart" style="width: 1.875rem; height: 1.875rem; position: static; padding-top: .9375rem;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div id="nav-account-section" class="nav-section">        
         <c:if test = "${sessionScope.acc.username != null }">
						...
						<nav id="nav-bar">
							<ul class="menu-level-1">
								<li class="item-level-1"><a href="#"
									class="item-level-1-title" style="text-decoration: none;"><h1 style="font-size: 15px;">Hello ${sessionScope.acc.username}</h1 ></a>
									<ul class="menu-level-2">
									<c:if test = "${sessionScope.acc.role == 1 }">
									<li class="item-level-2"><a href="./Manage.jsp"
											class="item-level-2-title">Manage</a></li> 
										<li class="item-level-2"><a href="./ManageOrder2.jsp"
											class="item-level-2-title">Manage Order</a></li>
											</c:if>
										<form action="ExistOder" method="post"><button type="submit" style="background-color: transparent; border: none; width: 100%;"><li class="item-level-2"><a 
											class="item-level-2-title" type="submit">
											<h style="font-size: 17px;">Existing Order</h></a></li></button></form>
									</ul></li>
							</ul>
						</nav>
					</div>
          ...
          <c:if test = "${sessionScope.acc.username == null }">
          <button class="form"><a id ="form" href="./login.jsp" style="text-decoration: none; color: #1673A1; font-size: 1.2rem;">Login</a></button>
          <button class="form"><a id ="form" href="./form.jsp" style="text-decoration: none; color: #1673A1;font-size: 1.2rem;"">Register</a></button>
          </c:if> 
        </div>
      </nav>
    </header>
    ...
    <div id="wrapper" style="padding-top: 70px; margin-top: 28px;">
      <div class="headline">
        <h3 style="font-size: 40px;">Tiramisu</h3>
      </div>    
      <ul class="products" style="padding-top: 30px; max-width: 73.125rem;">
        <c:forEach items ="${listtr}" var ="o">
            ...
            <div class="product-item">
              ...
              <button type="submit"><a class="buy-now" >Add to cart</a></button>
              </c:if>
              </div>             
              <div class="product-info">
                <a href="" class="product-cat"></a>
                <a href="" class="product-name">${o.name}</a>
                <a href="" class="product-price">${o.price}</a>               
              </div>            
            </div>
          </li>
          </form>
